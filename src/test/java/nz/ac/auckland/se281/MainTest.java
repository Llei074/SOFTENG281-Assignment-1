...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    public void T4_test_run() throws Exception {
      runCommands(
          unpack(
              ...
              "MMM", //
              PRINT_VENUES));
              assertContains("Majestic Monarch Mansion (MMM) - 1000 people - $2500 base hire fee. Next available on 29/05/2024");
    }

    @Test
    public void T4_01_no_venues() throws Exception {
      runCommands(PRINT_VENUES);
      assertContains("There are no venues in the system. Please create a venue first.");
    }
    ...
    @Test
    public void T4_03_make_booking_too_many_attendees() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES,
              SET_DATE,
      ...
      assertContains("Number of attendees adjusted from 280 to 260, as the venue capacity is 260.");
      assertContains("Successfully created booking 'HUD14D8O'");
      assertDoesNotContain("Booking not made", true);
    }
